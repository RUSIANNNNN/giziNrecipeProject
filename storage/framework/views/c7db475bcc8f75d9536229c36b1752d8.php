...
Buat Resep Baru Kamu
    ...
    <form action="<?php echo e(route('customer.recipes.store')); ?>" method="POST" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\test\giziNrecipeProject\resources\views/customer/recipes/create-user.blade.php ENDPATH**/ ?>